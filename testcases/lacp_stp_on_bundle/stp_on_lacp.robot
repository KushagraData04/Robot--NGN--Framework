*** Settings ***
Documentation       LACP setup in STBR 117,130 and DUT 118
Default Tags        LACP setup in STBR 117,130 and DUT 118
Library             SSHLibrary
...
Create bundle of the all interfaces and setup rstp
   ...
   FOR    ${port}    IN    @{DUT1_bundle_ports}
    ...
    Commit Testcase
    Write    rstp; priority 0; commit
    Write    interface ${root_port117}; priority 0;
    Read Until Prompt
    Commit Testcase
    Set Global Variable    ${counter}    1
...
Check States of RSTP DUT side
    ...
    FOR    ${port}    IN RANGE    2    ${total_ports} + 1
        Write    do show spanning-tree interface bundle-${port} 
        ${cli}=    Read Until Prompt
